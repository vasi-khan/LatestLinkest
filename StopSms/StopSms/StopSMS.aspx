<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StopSMS.aspx.cs" Inherits="StopSMS.StopSMS" %>
                        ...
                        <div class="card-body ">
                            <div class="row gy-3 px-lg-5 px-sm-1">
                                <div class="col-md-12">
                                    ...
                                    <h5 class="card-title text-center">STOP SMS</h5>
                                </div>
                                ...
                                <div class="col-md-12 text-center">
                                    <%--<button class="btn btn-sm btn-outline-success px-3 text-uppercase" onclick="showDiv2()">unsubscribe from
              sms</button>--%>
                                    <asp:Button ID="btnUnSubscribe" Visible="false" class="btn btn-sm btn-outline-success px-3 text-uppercase"
                                        OnClientClick="showDiv2();" runat="server" Text="unsubscribe from sms" OnClick="btnUnSubscribe_Click" />
                            ...
                            <div class="row text-center mt-5 mb-5" id="box2" runat="server" style="display: none">
                                <div class="col-md-12">
                                    <h5>Thank You. You have been unsubscribeds for receiving further SMS</h5>
