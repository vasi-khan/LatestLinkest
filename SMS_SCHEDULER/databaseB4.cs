...
namespace SMS_SCHEDULER
{
    class databaseB4
    {
        ...
        {
            return ConfigurationManager.ConnectionStrings["SMPPB4"].ConnectionString;
        }

        public static string GetdukeConnectstring()
        {
            return ConfigurationManager.ConnectionStrings["duke"].ConnectionString;
        }

        public static DataTable GetDukeDataTable(string sql)
        {
            DataTable dt = new DataTable();
            using (SqlConnection cnn = new SqlConnection(GetdukeConnectstring()))
            {
