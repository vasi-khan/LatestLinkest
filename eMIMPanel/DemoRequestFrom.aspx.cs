...
namespace eMIMPanel
{
    public partial class DemoRequestFrom : System.Web.UI.Page
    {
        ...
        private void LoadString()
        {
            ...
            //rm = new ResourceManager("Register.App_GlobalResources.Lang", Assembly.GetExecutingAssembly()); //we configure resource manages for mapping with resource files in App_GlobalResources folder.  
        ...
        public void Save()
        {
            ...
            common.request obj = new common.request();

            obj.EmployeeId = int.Parse((Session["USER"] as common.mlogin).employeeid.ToString());
            ...
            string msg = new common().SaveRequest(obj);
        ...
        public void FillProductSubGroup(int ProductId)
        {
            ...
            common.FillDropDown(ddlproductsubgroup, dt, "ProductName", "ProductId", 'S');
        }
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            dt = new common().GetDataTable("select 'XXXXXXXXXXXXXXX'+SUBSTRING(PEID,len(peid)-3,4)PEID,* from customer WHERE USERNAME='" + txtUserId.Text.Trim() + "'");
        ...
        //    try
        //    {
        //        List<common.product> list = new List<common.product>();
        //        DataTable dt = new common().GetDataTable("SELECT ProductId,ProductName FROM PRODUCT WHERE ParentId =-1");
        //        if (dt != null && dt.Rows.Count>0)
        //        {
        //                    foreach (DataRow dr in dt.Rows)
        //                    {
        //                common.product obj = new common.product();
        //                obj.id =dr["ProductId"].ToString().Trim();
        //                obj.id =dr["ProductName"].ToString().Trim();
        //                list.Add(obj);    
