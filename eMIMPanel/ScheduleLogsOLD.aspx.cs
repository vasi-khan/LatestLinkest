...
namespace eMIMPanel
{
    public partial class ScheduleLogsOLD : System.Web.UI.Page
    {
        string s1 = "";
        string s2 = "";
        string usertype = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Helper.Util ob = new Helper.Util();
                DataTable dt = ob.GetUserScheduledReport(user,ws, "02/JAN/1900", "02/JAN/1900");
                grv.DataSource = null;
                grv.DataSource = dt;
                grv.DataBind();
                GridFormat(dt);

                //dt = ob.GetUserScheduledReportDetail(user, "-22", false);
