<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Rcs-Reports_Usr.aspx.cs" Inherits="eMIMPanel.Rcs_Reports_Usr" %>
        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb breadcrumb-info">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">RCS Reports</li>
                </ol>
            </nav>
                            ...
                            <asp:GridView ID="grv2" HeaderStyle-Height="25px" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnDownLoad_Click" class="btn btn-datatable btn-icon btn-transparent-dark px-2 py-0" data-toggle="tooltip" data-placement="top" title="XLS"><i class="far fa-file-excel"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <div class="col-xl-12 col-lg-12">
                    ...
                    <div class="card bg-primary border-light shadow-soft mb-4">
                        <div class="card-header py-3 bg-primary d-flex flex-column flex-lg-row justify-content-lg-between flex-wrap align-content-lg-center">
                            <h6 class="m-0 font-weight-bold my-auto">RCS Reports</h6>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:LinkButton ID="LinkButton2" OnClientClick=<%# "view('" + Eval("id") + "'); return false;" %> runat="server" class="btn btn-datatable btn-icon btn-transparent-dark px-2 py-0" data-toggle="tooltip" data-placement="top" title="Details"><i class="far fa-file-alt"></i></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Submit Date Time" HeaderStyle-CssClass="text-wrap">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblmobile" runat="server" CssClass="text-wrap" Text='<%#Eval("CreatedDate")%>'></asp:Label>
                                                                    <asp:HiddenField ID="hdnFileId" runat="server" Value='<%#Eval("id")%>'></asp:HiddenField>
                                                                    <asp:HiddenField ID="hdnUserId" runat="server" Value='<%#Eval("username")%>'></asp:HiddenField>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Rejected">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl6" runat="server" Text='<%#Eval("Rejected")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Unknown">
                                                                <ItemTemplate>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <asp:Label ID="lblHeading" runat="server" CssClass="modal-title" Text="RCS Report Details"></asp:Label>
                </div>
    ...
    <script type="text/javascript">  
        function view(fileid) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "WebService.asmx/GetRCSReportDetailUserNew",
                data: { fid: fileid},
