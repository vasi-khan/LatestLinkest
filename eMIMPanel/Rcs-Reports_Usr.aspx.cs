...
namespace eMIMPanel
{
    public partial class Rcs_Reports_Usr : System.Web.UI.Page
    {
        string d1 = "";
        string d2 = "";
        string s1 = "";
        ...
        public void GetData()
        {
            ...
            DataTable dt = ob.SP_GetRCSReports(user, Convert.ToString(ddlCamp.SelectedValue));
            grv.DataSource = null;
            grv.DataSource = dt;
            SetFooterValue(dt);
            grv.DataBind();
        ...
        protected void btnXL_Click(object sender, EventArgs e)
        {
            ...
            //DataTable dt = ob.GetSMSReportDetail_user_new(userid.Value, fileid.Value, s1, s2);
            DataTable dt = ob.RcsReportViewDetails(fileid.Value);
            Session["MOBILEDATA"] = dt;

            if (dt.Rows.Count > 0)
            {
                Session["FILENAME"] = "RCSReportDetail.xls";
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("RcsDelivery.aspx");
            /*
            try
            {
                if (txtmob.Text.Trim() != "")
        ...
        private void SetFooterValue(DataTable copyDataTable)
        {
            ...
            grv.Columns[6].FooterText = sumRejected.ToString();
            grv.Columns[7].FooterText = sumUnknown.ToString();
            grv.Columns[8].FooterText = sumSeenCount.ToString();
        ...
        {
            Response.Redirect("RCS_Summary_U.aspx");
