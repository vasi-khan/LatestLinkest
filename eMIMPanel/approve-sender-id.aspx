<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="approve-sender-id.aspx.cs" Inherits="eMIMPanel.approve_sender_id" %>
                ...
                <div class="container-fluid">
                    <nav aria-label="breadcrumb" class="my-3">
                        <ol class="breadcrumb breadcrumb-info">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Approve Sender Id</li>
                        </ol>
                    </nav>
                    <!-- Content Row -->
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="card bg-primary border-light shadow-soft mb-4">
                                <div class="card-header py-3 bg-primary d-flex justify-content-between flex-wrap align-content-center">
                                    <h6 class="m-0 font-weight-bold font-weight-bold my-auto"><i class="far fa-id-card"></i>Approve Sender Id</h6>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="LinkButton1" runat="server" class="mx-1 btn btn-primary text-success"  
                                                        OnClientClick="return confirm('Do you want to Approve this Sender ID ?');" OnClick="btnApprove_Click"
                                                     ...
                                                     <asp:LinkButton ID="LinkButton2" runat="server" class="mx-1 btn btn-primary text-danger"  
                                                         OnClientClick="return confirm('Do you want to Reject this Sender ID ?');" OnClick="btnReject_Click"
