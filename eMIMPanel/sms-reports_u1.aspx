<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="sms-reports_u1.aspx.cs" Inherits="eMIMPanel.sms_reports_u1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <div class="right-view">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                               ...
                                               <asp:Button id="btn" runat="server" text="show2" onclientclick="test1(); return false;"></asp:Button>
    ...
    <script type="text/javascript">  
        function test1()
        {
            ...
            var startDate = document.getElementById("ContentPlaceHolder1_txtFrm").value;
            var endDate = document.getElementById("ContentPlaceHolder1_txtTo").value;
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "WebService.asmx/GetSMSReportUser",
                data: { dater: startDate + '$' + endDate + '$' + user },
