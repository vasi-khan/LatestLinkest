<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CategoryMaster.aspx.cs" Inherits="eMIMPanel.CategoryMaster" %>
            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb" class="my-3">
                    <ol class="breadcrumb breadcrumb-info">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Group Location Master</li>
                    </ol>
                </nav>
                        ...
                        <div class="card bg-primary border-light shadow-soft mb-4">
                            <div class="card-body px-4">
                                <asp:Panel ID="pnlMain" runat="server">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label>Group Location Code</label>
                                            <asp:TextBox ID="txtCatCode" runat="server" CssClass="form-control" onkeypress="return /^[a-zA-Z0-9-_\s]{0,20}$/.test(this.value+event.key);" MaxLength="20"></asp:TextBox>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Group Location Name</label>
                                            <asp:TextBox ID="txtCatName" runat="server" CssClass="form-control" onkeypress="return /^[a-zA-Z0-9-_.\s]{0,100}$/.test(this.value+event.key);" MaxLength="100"></asp:TextBox>
                                        </div>
                            ...
                            <div class="mt-5 px-4" runat="server" id="divgrdtran">
                                <asp:GridView ID="grd" border="0" runat="server" CellPadding="10" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Group Location Code" HeaderStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCategoryID" runat="server" Text='<%#Eval("CategoryID")%>' Width="100%"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Group Location Name" HeaderStyle-Width="55%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:HiddenField Value='<%#Eval("CategoryID") %>' ID="HD_CategoryID" runat="server" />
