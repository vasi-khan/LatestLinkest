...
namespace eMIMPanel
{
    public partial class sms_reports_usrDLR29 : System.Web.UI.Page
    {
        string d1 = "";
        string d2 = "";
        string s1 = "";
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rdbCamp.Checked)
                    dt = ob.GetSMSReport_user_newConsolidated(d1, d2, txtmob.Text, user, ddlCamp.SelectedValue, "");
                else
                { 
        ...
        private void SetFooterValue(DataTable copyDataTable)
        {
            ...
            grv2.Columns[3].FooterText = "Total : ";
            grv2.Columns[4].FooterText = sumSubmitted.ToString();
            grv2.Columns[5].FooterText = sumDelivered.ToString();
            grv2.Columns[6].FooterText = sumFailed.ToString();
