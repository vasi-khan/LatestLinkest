...
namespace eMIMPanel
{
    public partial class profile_u : System.Web.UI.Page
    {
        ...
        public void getDtl()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //txtPEID.Text = Convert.ToString(dt.Rows[0]["PEID"]);
                if (user == "MIM2102131") txtPEID.Text = "";
                 PopulateSender();
            ...
            {
                lblPEID.Visible = false;
                txtPEID.Visible = false;
            }
        }
        ...
        {
            ob.UpdateCustomer(Convert.ToString(Session["UserID"]), ddlSender.SelectedValue, txtWebsite.Text, rdbDnd.Checked);
