<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="rcs-reports.aspx.cs" Inherits="eMIMPanel.rcs_reports" %>
                            ...
                            <div class="table-responsive">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" runat="server" class="mx-1 btn btn-primary text-success"
                                                ...
                                                <span class="text-success"> <i class="fas fa-file-excel"></i> </span></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Failed">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lbl5" runat="server" Text='<%#Eval("Rejected")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
