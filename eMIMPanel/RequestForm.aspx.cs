...
namespace eMIMPanel
{
    public partial class RequestForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ddLang.SelectedValue = Session["Lang"].ToString(); //Request.UserLanguages[0];
                ...
                FillTransType();
                OrderType();
                ddlEmployee.SelectedValue = (Session["USER"] as Helper.common.mlogin).employeeid.ToString();
        ...
        private void LoadString()
        {
            ...
            rm = new ResourceManager("eMIMPanel.App_GlobalResources.Lang", Assembly.GetExecutingAssembly()); //we configure resource manages for mapping with resource files in App_GlobalResources folder.  
        ...
        public void Save()
        {
           ...
           Helper.common.request obj = new Helper.common.request();
            ...
            obj.EmployeeId = int.Parse((Session["USER"] as Helper.common.mlogin).employeeid.ToString());
