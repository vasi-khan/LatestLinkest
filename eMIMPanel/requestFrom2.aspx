<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="requestFrom2.aspx.cs" Inherits="eMIMPanel.requestFrom2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <meta name="author" content="My Inbox Media &reg;">
    ...
    <style>
        ...
        input#ContentPlaceHolder1_txtPhone2 {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container body-content">
        ...
        <div class="d-flex justify-content-end">
            <div class="form-floating my-2 px-3">
                <asp:DropDownList ID="ddLang" runat="server" CssClass="btn btn-primary" AutoPostBack="true" OnSelectedIndexChanged="ddLang_SelectedIndexChanged">
                    ...
                    <div class="container-fluid py-lg-1">
                        <nav aria-label="breadcrumb" class="my-3">
                            <ol class="breadcrumb breadcrumb-info">
                                ...
                                <li class="breadcrumb-item active" id="Campaign_Request_Form" runat="server" aria-current="page">Campaign Request Form</li>
                            </ol>
                        </nav>
                        <div class="card card-body mb-4 bg-primary border-light shadow-soft">
                        <div class="row p-2 g-lg-5 h-100 align-items-center justify-content-center">
                            <%--                <div class="col-md-5 col-lg-6 order-md-last">

                    <img src="img/support-img-01.svg" alt="" class="img-fluid">
                </div>--%>
                                    ...
                                    <div class="tab-pane fade show active" id="home" runat="server" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <form class="needs-validation" novalidate>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <asp:DropDownList ID="ddlEmployee" CssClass="form-control" Enabled="false" runat="server">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="tel" class="form-control" onkeypress="return onlyNumberKey(event)" id="txtPhone2" runat="server" placeholder="Mobile Number" maxlength="12" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <asp:DropDownList runat="server" ID="ddlProduct" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged" AutoPostBack="true" onchange="HideTextBox()" CssClass="form-control">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <asp:DropDownList runat="server" ID="ddlproductsubgroup" CssClass="form-control">
                                                            <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                        ...
                                        <asp:ListItem Text="SMPP" Value="3"></asp:ListItem>--%>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <asp:DropDownList runat="server" ID="ddltranstype" CssClass="form-control">
                                                            <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-6 col-sm-6">
                                                    <asp:RadioButtonList runat="server" ID="rbcredentials" onchange="showhidediv()" RepeatDirection="Horizontal">
                                                        <asp:ListItem Text="Client" Selected="True" class="btn btn-outline-primary me-3 text-black" Value="Client"></asp:ListItem>
                                                        <asp:ListItem Text="MIM" class="btn btn-outline-primary me-3 text-black" Value="MIM"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 text-center mt-4">
                                                    <asp:Button runat="server" ID="btnSave" Text="Submit" OnClick="btnSave_Click" CssClass=" btn btn-primary " />
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $(function () {
          //alert($('#<%= hfiso2.ClientID %>').val());
            $('#ContentPlaceHolder1_txtPhone2').intlTelInput({
           ...
           <%--  $('#<%= rbcredentials.ClientID %>').on('onchange', function () {
            ...
            $('#<%= btnSave.ClientID %>').on('click', function () {
                ...
                var iso2 = $("#ContentPlaceHolder1_txtPhone2").intlTelInput("getSelectedCountryData").iso2;
                var code = $("#ContentPlaceHolder1_txtPhone2").intlTelInput("getSelectedCountryData").dialCode;
                $('#<%= hfCountryCode.ClientID %>').val(code);
                $('#<%= hfiso2.ClientID %>').val(iso2);

                var mobentr = $('#ContentPlaceHolder1_txtPhone2').val().length;
