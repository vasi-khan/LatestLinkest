<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="analytics_u.aspx.cs" Inherits="eMIMPanel.analytics_u" %>
                        ...
                        <div class="form-row">
                            <div class="right-view">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <asp:LinkButton runat="server" ID="aaaa" OnClick="btnUpdate_Click" OnClientClick="return CheckDates();" class="btn btn-mini">
