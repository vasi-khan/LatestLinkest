...
namespace eMIMPanel
{
    public partial class analyticsRichMedia_u1 : System.Web.UI.Page
    {
        string s1 = "";
        string s2 = "";
        string usertype = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Helper.Util ob = new Helper.Util();
                DataTable dt = ob.GetUserReport(user,ws, "02/JAN/1900", "02/JAN/1900", false,"Y");
                grv.DataSource = null;
                grv.DataSource = dt;
                grv.DataBind();
                GridFormat(dt);
        ...
        public void GetData()
        {
            ...
            //DataTable dt = ob.GetUserReport(user, Request.Url.Scheme + @"://" + Request.Url.Authority, s1, s2, false,"Y");
            DataTable dt = ob.GetUserReport(user, "", s1, s2, false, "Y");
            grv.DataSource = null;
            grv.DataSource = dt;
            grv.DataBind();
        ...
        protected void lnkDownload_Click(object sender, EventArgs e)
        {
            if (grv.Rows.Count > 0)
            {
                ...
                DataTable distinctValues = view.ToTable(true, "userid", "smallURL", "CreationDate", "No_Of_Hits", "URLID");
                DatatableToCSV(distinctValues, "AnalyticsRichMedia.csv");  //ExportToExcel();
        ...
        protected void lnkDownloadDetails_Click(object sender, EventArgs e)
        {
            if (grv.Rows.Count > 0)
            {
                ...
                DatatableToCSV(distinctValues, "AnalyticsRichMediaDetails.csv");  //ExportToExcel();
