...
namespace eMIMPanel
{
    public partial class smsSummaryU : System.Web.UI.Page
    {
        string s1 = "";
        string s2 = "";
        string usertype = "";
        ...
        public void GetData()
        {
            ...
            DataTable dt = ob.GetDayWiseSMSSummary(user, s1, s2);
            grv.DataSource = null;
            grv.DataSource = dt;
            SetFooterValue(dt);
            grv.DataBind();
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            string user = Convert.ToString(Session["UserID"]);
            DataTable dt = ob.GetDayWiseSMSSummaryDetail(user, lbldate.Text);
