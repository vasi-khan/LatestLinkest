<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index2.aspx.cs" Inherits="eMIMPanel.index2" %>
                                                        ...
                                                        <asp:GridView ID="grv" HeaderStyle-Height="25px" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                                            <asp:GridView ID="nestedgv" runat="server" AutoGenerateColumns="false" CssClass="ChildGrid" DataKeyNames="Username" OnRowDataBound="nestedgv_RowDataBound">
                                                                                <Columns>
                                                                  ...
                                                                  <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Panel ID="pnlgridtwo" runat="server" Style="display: none">
                                                                            <asp:GridView ID="twonestedgv" runat="server" AutoGenerateColumns="false" CssClass="SecChildGrid">
                                                                                <Columns>
                                                                                   ...
                                                                                   <%-- <asp:BoundField ItemStyle-Width="150px" DataField="SubmittedPer" HeaderText="Submitted (%)" />--%>
                                                                                    ...
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="Username" HeaderText="UserId" />
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="dltno" HeaderText="DLT No" />
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="Submitted" HeaderText="Submitted" />
                                                                                  <%--  <asp:BoundField ItemStyle-Width="150px" DataField="SubmittedPer" HeaderText="Submitted (%)" />--%>
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="Delivered" HeaderText="Delivered" />
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="Failed" HeaderText="Failed" />
                                                                ...
                                                                <%--<asp:TemplateField HeaderText="" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl1111" runat="server" Text='<%#Eval("Submitted")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>--%>
