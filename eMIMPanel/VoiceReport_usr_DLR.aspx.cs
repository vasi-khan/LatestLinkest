...
namespace eMIMPanel
{
    public partial class VoiceReport_usr_DLR : System.Web.UI.Page
    {
        string d1 = "";
        string d2 = "";
        string s1 = "";
        ...
        {
            //d1 = Convert.ToDateTime(hdntxtFrm1.Value).ToString();
            //d2 = Convert.ToDateTime(hdntxtTo1.Value).ToString();
            ...
            if ((hdntxtFrm1.Value) == "" && (hdntxtTo1.Value) == "")
            {
                ...
                //ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Select Date ');", true);
                //return;
            }
            ...
            string proc = "SP_VoiceReport";
            List<SqlParameter> pram = new List<SqlParameter>();
            pram.Clear();
            pram.Add(new SqlParameter("@customerid", user));
        ...
        private void ExportToExcel()
        {
            ...
            string attachment = "attachment; filename=VoiceReport.xls";
