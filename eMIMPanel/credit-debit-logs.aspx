<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="credit-debit-logs.aspx.cs" Inherits="eMIMPanel.credit_debit_logs" %>
    ...
    <script type="text/javascript">  
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "WebService.asmx/GetCRDRLog",
                data: { dater: startDate + '$' + endDate + '$' + user + '$' + usertype + '$' + dlt  },
