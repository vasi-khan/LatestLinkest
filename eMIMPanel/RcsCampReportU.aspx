<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="RcsCampReportU.aspx.cs" Inherits="eMIMPanel.RcsCampReportU" %>
        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb breadcrumb-info">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">RCS Campaign Report</li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-12">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="card mb-4 bg-primary border-light shadow-soft">
                                <div class="card-header pt-3 pb-0 bg-primary d-flex justify-content-between flex-wrap align-items-center">
                                    <div class="flex-fill">
                                        <h6 class="font-weight-bold mb-0"><i class="fas fa-chart-line"></i>RCS Campaign Report</h6>
                                    </div>
                                    <div class="downB">
