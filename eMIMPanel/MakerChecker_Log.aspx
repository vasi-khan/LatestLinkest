<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="MakerChecker_Log.aspx.cs" Inherits="eMIMPanel.MakerChecker_Log" %>
        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb breadcrumb-info">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Maker Checker Report</li>
                </ol>
            </nav>
            <!-- Nav End -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body mb-4 bg-primary border-light shadow-soft">
                        <div class="form-row">
                            <div class="col-md-2 mt-2 ml-2 mb-2 font-weight-bold">
                                <asp:Label ID="lblCampheading" runat="server" Text="Campaign Date"></asp:Label>
                            </div>
                        </div>
                        <div class="form-row">
                    ...
                    <div class="card mb-4 bg-primary border-light shadow-soft">
                        <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                            <div class="flex-fill m-0 font-weight-bold">Maker Checker Report</div>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grv" HeaderStyle-Height="25px" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="CampName">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="No Of Count">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNoOfCount" runat="server" Text='<%#Eval("Noofrecord")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Maker DateTime">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMakerDate" runat="server" Text='<%#Eval("InsertTime")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Checker DateTime">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCheckerDate" runat="server" Text='<%#Eval("CheckerDate")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Dispose DateTime">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldispotDateTime" runat="server" Text='<%#Eval("DisposeDateTime")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Dispose Remarks">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldispotRemarks" runat="server" Text='<%#Eval("disposereason")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Camp Start Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCampStartDate" runat="server" Text='<%#Eval("CampStartDate")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
