<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CreateAccount.aspx.cs" Inherits="eMIMPanel.CreateAccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="card bg-primary border-light shadow-soft mb-4">
                                ...
                                <div class="card-body">
                                    <asp:Panel ID="pnlMain" runat="server">
                                        <asp:Panel ID="pnledit" runat="server" Visible="false">
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <asp:TextBox class="form-control" ID="txtAccountID" runat="server" placeholder="Enter Account ID to Edit" />
                                                </div>
                                                <div class="col-md-6 mb-3">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <asp:TextBox class="form-control" ID="txtName" runat="server" placeholder="Full Name" ToolTip="Full Name" />
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtCompName" runat="server" placeholder="Company Name" ToolTip="Company Name" />
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtWebsite" runat="server" placeholder="Website : www." ToolTip="Website" />
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtMob1" runat="server" placeholder="Mobile No. 01" MaxLength="12" ToolTip="Mobile No" />
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtSender" placeholder="Alpha Sender Id * :" runat="server" MaxLength="12" ToolTip="Sender ID" />
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtEmail" placeholder="Email Id" runat="server" ToolTip="Email ID" />
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <!-- <label for="validationCustom06" class="font-weight-bold">Email Id</label> -->
                                                <asp:TextBox class="form-control" ID="txtccemail" placeholder="CC Email Id" runat="server" ToolTip="CC Email ID" />
                                                <%--<input type="email" class="form-control" id="validationCustom06" placeholder="Email Id">--%>
                                                <div class="invalid-feedback">
                                                    Please provide a valid zip.
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <asp:TextBox class="form-control" ID="txtExpiry" runat="server" placeholder="Expiry Date" autocomplete="off" ToolTip="Expiry Date" />
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <!-- <label for="validationCustom05" class="font-weight-bold">Mobile No. 01</label> -->
                                                <asp:TextBox class="form-control" ID="txtDLT" runat="server" placeholder="DLT No" MaxLength="20" ToolTip="DLT No" />
                                        ...
                                        <div class="form-row">
                                           ...
                                           <div class="col-md-6 mb-3" runat="server" id="pwd" visible="true">
                                                <asp:TextBox class="form-control" ID="txtPwd" onkeypress="return RestrictKey(event)" placeholder="Password" ToolTip="Password" runat="server" />
                                                <div class="invalid-feedback">
                                                    Please provide a valid Password.                             
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <asp:DropDownList ID="ddlemployee" runat="server" class="drop-select form-control">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3 mb-3" runat="server" id="RCS" Visible="false">
                                                <asp:CheckBox  ID="chkWABA" runat="server" Text="Activate WABA RCS" />
                                            </div>
                                            <div class="col-md-3 mb-3">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <!-- <label for="validationCustom05" class="font-weight-bold">Group Name</label> -->
                                                <asp:TextBox class="form-control" ID="txtgroupname" runat="server" placeholder="Group Name" MaxLength="30" ToolTip="Group Name" />

                                                <%--<input type="text" class="form-control" id="validationCustom05" placeholder="Group Name">--%>
                                            </div>
                                            <div class="col-md-6 mb-3">
    ...
    <script type="text/javascript">  
        ...
        function RestrictKey(evt) {
            ...
            if ((ASCIICode == 37 || ASCIICode == 38 || ASCIICode == 39 || ASCIICode == 34 || ASCIICode == 63 || ASCIICode == 64 || ASCIICode == 58))
                return false;
            return true;
        }
    </script>
