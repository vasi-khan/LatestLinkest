<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="eMIMPanel.Dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:UpdatePanel ID="updFormArea" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-body py-2 mb-4 bg-light border-light shadow-inset">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div class="card bg-light border-light shadow-soft mb-4">
                                ...
                                <div class="card-body py-2">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 mb-4">
                                            <div class="card bg-light shadow-inset border-light h-100 py-2">
                                                <!-- Card Body -->
                                                        ...
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                                    ...
                                                                    Submitted
                                                                     <asp:Label ID="lblMonthSubmitted" class="count_text" runat="server" Text="0"></asp:Label>
                                                        ...
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                                                                    ...
                                                                    Failed
                                                                     <asp:Label ID="lblMonthFailed" class="count_text px-2" runat="server" Text="0"></asp:Label>
                                                                </div>
                    ...
                    <div class="card bg-light shadow-soft border-light">
                                                ...
                                                <div class="col-sm-12 mt-2">
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="grv" HeaderStyle-Height="25px" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                                            runat="server" Width="100%" CellPadding="10" BorderColor="#ede8e8" Class="table table-striped table-bordered dt-responsive wrap dataTable-view1" DataKeyNames="groupname"
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                                            <asp:GridView ID="nestedgv" runat="server" AutoGenerateColumns="false" CssClass="ChildGrid">
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="Username" HeaderText="UserId" />
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="Submitted" HeaderText="Submitted" />
                                                                                    <asp:BoundField ItemStyle-Width="150px" DataField="SubmittedPer" HeaderText="Submitted (%)" />
                                                ...
                                                <div class="col-sm-12 mt-2">
                                                    <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" CssClass="Grid"
                                                        ...
                                                        <Columns>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                                        <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="false" CssClass="ChildGrid">
                                                                            <Columns>
                                                                                <asp:BoundField ItemStyle-Width="150px" DataField="username" HeaderText="UserId" />
                                                                                <asp:BoundField ItemStyle-Width="150px" DataField="AccountCreatedon" HeaderText="Date" />
                                                                            </Columns>
                                                                        </asp:GridView>
                                                                    </asp:Panel>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:BoundField ItemStyle-Width="150px" DataField="EmpCode" HeaderText="Employee Code" />
                                                        </Columns>
                                                    </asp:GridView>
                                                </div>
    ...
    <script src="OffLineCDN/dashboard/c3.min.js"></script>
    <script src="OffLineCDN/dashboard/d3.min.js"></script>
