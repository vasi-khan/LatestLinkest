...
namespace eMIMPanel
{
    public partial class ViewDetailSubClient : System.Web.UI.Page
    {
        ...
        public void fillgrid()
        {
            if (Request.QueryString["A"] != null)
            {
                ...
                DataTable dt = new Util().GetSMSSubClientReportDetail_user_new(dtr[2], dtr[3], dtr[4], dtr[0], dtr[1], dtr[5], dtr[6],dtr[7]);
