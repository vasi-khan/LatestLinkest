<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CreateAccountBD.aspx.cs" Inherits="eMIMPanel.CreateAccountBD" %>
                ...
                <div class="container-fluid">
                    <nav aria-label="breadcrumb" class="my-3">
                        <ol class="breadcrumb breadcrumb-info">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Account BD</li>
                        </ol>
                    </nav>
                    <!-- Content Row -->
                                ...
                                <div class="card-body">
                                    <asp:Panel id="pnlMain" runat="server" >
                                       ...
                                       <%-- <div class="form-row">
                                        ...
                                        <%--<div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <asp:TextBox class="form-control d-none" ID="txtDLT" runat="server" placeholder="DLT No" MaxLength="20"  />
                                                <div class="invalid-feedback">
                                                    Please select a valid state.
                                                </div>
                                            </div>
