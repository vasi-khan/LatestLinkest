...
namespace eMIMPanel
{
    public partial class send_sms_insurance : System.Web.UI.Page
    {
        string tempVar = "{#var#}";
        string _user = "";
        string paisa = "";
        ...
        string insurance = System.Configuration.ConfigurationManager.AppSettings["InsuranceCompUserId"].ToString();
        ...
        {
            Helper.Util ob = new Helper.Util();
            DataTable dt = database.GetDataTable(@"select EventName + ' (' + EventID + ')' as Events,EventID from EventMast order by InsertDate desc");
            if (dt.Rows.Count == 0)
            {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            //string chkcountry = CheckUAEAccount();
            //if (chkcountry != "")
            //{
            //    string msg = chkSenderMappedOperator(ddlSender.SelectedValue);
            //    if (msg == "")
            //    {
            //        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert", "alert('Sender Id  is Not Mapped with Operator, SMS Not Sent !!');", true);
            //        return;
            //    }
            //}
        ...
        public bool MsgSend(string sch)
        {
            ...
            //if (Convert.ToString(Session["DLT"]).ToLower() == Convert.ToString(DLTNO).ToLower() && ddldlrname.SelectedValue != "0")
            //{
            //    IsDLRData = 1;
            ...
            if (sch != "")
            {
                if (Convert.ToString(Session["XLUPLOADED"]) == "Y")
                {
                    ...
                    INSERT INTO FileProcess(id,profileid,fileName,tblname,noofrecord,templateid,msg,sender,isprocessed,processedtime,isschedule,scheduletime,ccode,fileext,rate,smstype,methodname,shortURLId,shortURL,domainname,ucs2,noofsms,campname,scratchcard,EventCode,IsDLRData,dlrcode)
                    SELECT @maxid,'" + UserID + @"' ,'" + filenm + @"' ,'" + tblname + @"','" + cnt + @"','" + templID + @"',N'" + txtMsg.Text.Trim().Replace("'", "''") + @"'" +
                     ",'" + ddlSender.SelectedValue + @"',0,Null,1,'" + scheduleDate + @"','" + country_code + @"','" + filenmext + @"'," + rate + ",'" + ddlSMSType.SelectedValue + @"','Schedule_SMS_BULK', '" + shortURLId + @"','" + shortURL + @"','" + ws + @"','" + ucs2 + @"'," + noofsms + ",'" + txtCampNm.Text.Trim() + @"'," + IsScratched + ",'" + EventsCode + @"'," + IsDLRData + ", '" + dlrcode + "' " +
                ...
                else
                {
                    ...
                    if (bulk)
                    {
                        ...
                        // foreach (string scheduleDate in liScheduleDates)
                        {
                            ...
                            string sq = @"declare @maxid int 
                    set @maxid=isnull((select max(id) From FileProcess),0)+1
                    INSERT INTO FileProcess(id,profileid,fileName,tblname,noofrecord,templateid,msg,sender,isprocessed,processedtime,ccode,smstype,shorturlid,shorturl,domainname,ucs2,noofsms,campname,prevbalance,availablebalance,isschedule,scheduletime,fileext,rate,methodname,scratchcard,EventCode,isdlrdata,dlrcode)
                    ...
                    else
                    {
                        ...
                        foreach (var m in mobList)
                        {
                            ...
                            if (chk == 0)
                            {
                                ...
                                ob.B4SEND_Schedule_SMS(UserID, m, msg, ddlSender.Text, schdate, shortURLId, shortURL, ws, mseg, rate, ddlSMSType.SelectedValue, dtSMPPAC, ucs2, templID, country_code, fileId, dlrcode);
                                ob.GetSchedule_SMS(liScheduleDates, UserID, country_code);
                                //if (ddlSMSType.SelectedValue == "2")
            ...
            else
            {
                ...
                if (Convert.ToString(Session["XLUPLOADED"]) == "Y")
                {
                    ...
                    select* into " + tblname + @" from " + dbName + ".dbo." + user + @" ";
                        ...
                        sq = sq + @" INSERT INTO FileProcess(id,profileid,fileName,tblname,noofrecord,templateid,msg,sender,isprocessed,processedtime,ccode,smstype,shorturlid,shorturl,domainname,ucs2,noofsms,campname,prevbalance,availablebalance,fileext,rate,methodname,scratchcard,EventCode,isdlrdata,dlrcode)
              ...
              "'" + country_code + @"','" + ddlSMSType.SelectedValue + @"','" + shortURLId.ToString() + @"','" + shortURL + @"','" + ws + @"','" + ucs2 + @"','" + noofsms + @"','" + txtCampNm.Text + @"'," + PrevBalance + "," + PrevBalance + ",'" + filenmext + "'," + rate + ",'Insert_SMS_BULK_4url'," + IsScratched + ",'" + EventsCode + @"','" + IsDLRData + "','" + dlrcode + "'";
                    ...
                    SELECT @maxid,'" + UserID + @"' ,'" + filenm + @"' ,'" + tblname + @"','" + cnt + @"','" + templID + @"',N'" + txtMsg.Text.Trim().Replace("'", "''") + @"','" + ddlSender.SelectedValue + @"',0," +
                        "Null,'" + country_code + @"','" + ddlSMSType.SelectedValue + @"','" + shortURLId.ToString() + @"','" + shortURL + @"','" + ws + @"','" + ucs2 + @"','" + noofsms + @"','" + txtCampNm.Text + @"'," + PrevBalance + "," + PrevBalance + ",'" + filenmext + "'," + rate + ",'InsertSMSrecordsFromUSERTMP'," + IsScratched + ",'" + EventsCode + @"','" + IsDLRData + "','" + dlrcode + "'";
                    ...
                    select * into " + tblname + @" from " + dbName + ".dbo." + user + @"";
                            ...
                            sq = sq + @" INSERT INTO FileProcess(id,profileid,fileName,tblname,noofrecord,templateid,msg,sender,isprocessed,processedtime,ccode,smstype,shorturlid,shorturl,domainname,ucs2,noofsms,campname,prevbalance,availablebalance,fileext,rate,methodname,scratchcard,EventCode,isdlrdata,dlrcode)
                    SELECT @maxid,'" + UserID + @"' ,'" + filenm + @"' ,'" + tblname + @"','" + cnt + @"','" + templID + @"',N'" + txtMsg.Text.Trim().Replace("'", "''") + @"','" + ddlSender.SelectedValue + @"',0,Null,
                    '" + country_code + @"','" + ddlSMSType.SelectedValue + @"','" + shortURLId.ToString() + @"','" + shortURL + @"','" + ws + @"','" + ucs2 + @"','" + noofsms + @"','" + txtCampNm.Text + @"'," + PrevBalance + "," + PrevBalance + ",'" + filenmext + "'," + rate + ",'InsertSMSrecordsFromUSERTMP'," + IsScratched + ",'" + EventsCode + @"'," + IsDLRData + ",'" + dlrcode + "'";
...
SELECT* INTO " + tblname + @" from " + dbName + ".dbo." + user + @" ";
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('SMS Sent Successfully');window.location ='send-sms-insurance.aspx';", true);
            }
            return true;
        }
        ...
        public bool SendTemplateMSG(string sch)
        {
            ...
            if (sch != "")
            {
                if (Convert.ToString(Session["XLUPLOADED"]) == "Y")
                {
                    ...
                    // foreach (string scheduleDate in liScheduleDates)
                    {
                        ...
                        string sq = @"declare @maxid int 
                    set @maxid=isnull((select max(id) From FileProcess),0)+1
                    INSERT INTO FileProcess(id,profileid,fileName,tblname,noofrecord,templateid,msg,sender,isprocessed,processedtime,ccode,smstype,shorturlid,shorturl,domainname,ucs2,noofsms,campname,prevbalance,availablebalance,fileext,rate,methodname,IsSchedule,ScheduleTime,EventCode,IsDLRData,dlrcode)
                    SELECT @maxid,'" + UserID + @"' ,'" + filenm + @"' ,'" + tblname + @"','" + cnt + @"','" + templateID + @"',N'" + txtMsg.Text.Trim().Replace("'", "''") + @"','" + ddlSender.SelectedValue + @"',0,Null,
                    '" + country_code + @"','" + ddlSMSType.SelectedValue + @"','" + shortURLId.ToString() + @"','" + shortURL + @"','" + ws + @"','" + ucs2 + @"','" + noofsms + @"','" + txtCampNm.Text + @"'," + PrevBalance + "," + PrevBalance + ",'" + filenmext + "'," + rate + ",'InsertTemplateSMSrecordsFromUSERTMP',1,'" + scheduleDate + "'t,'" + EventsCode + "','" + IsDLRData + "','" + dlrcode + "' " +
                    " SELECT * INTO " + tblname + @" from " + dbName + ".dbo." + user + @" ";
            ...
            else
            {
                ...
                if (Convert.ToString(Session["XLUPLOADED"]) == "Y")
                {
                    ...
                    sq = sq + @" INSERT INTO FileProcess(id,profileid,fileName,tblname,noofrecord,templateid,msg,sender,isprocessed,processedtime,ccode,smstype,shorturlid,shorturl,domainname,ucs2,noofsms,campname,prevbalance,availablebalance,fileext,rate,methodname,EventCode,isdlrdata,dlrcode)
                    SELECT @maxid,'" + UserID + @"' ,'" + filenm.Replace("'", "''") + @"' ,'" + tblname + @"','" + cnt + @"','" + templateID + @"',N'" + txtMsg.Text.Trim().Replace("'", "''") + @"','" + ddlSender.SelectedValue + @"',0,Null,
                    '" + country_code + @"','" + ddlSMSType.SelectedValue + @"','" + shortURLId.ToString() + @"','" + shortURL + @"','" + ws + @"','" + ucs2 + @"','" + noofsms + @"','" + txtCampNm.Text + @"'," + PrevBalance + "," + PrevBalance + ",'" + filenmext.Replace("'", "''") + "'," + rate + ",'InsertTemplateSMSrecordsFromUSERTMP','" + EventsCode + @"'," + IsDLRData + ", '" + dlrcode + "'";
        ...
        protected void btnShowLongURL_Click(object sender, EventArgs e)
        {
            if (ddlURL.SelectedIndex >= 0)
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    //lblLongUrl.Text = dt.Rows[0][0].ToString().Substring(0, 50);
                    //lblLongUrl.ToolTip = "Long Url: " + dt.Rows[0][0].ToString();
                }
        ...
        protected void btnScheduleSMS_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (res == true)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('SMS Scheduled Successfully');window.location ='send-sms-insurance.aspx';", true);
        ...
        protected void btnInsTemplate_Click(object sender, EventArgs e)
        {
            ...
            PopulateTemplate();
            Helper.Util ob = new Helper.Util();
            DataTable dt = ob.GetFieldsOfUserUploadedXLS(Convert.ToString(Session["UserID"])); //Get xls columns names
