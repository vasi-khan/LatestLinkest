<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="smsSummaryU.aspx.cs" Inherits="eMIMPanel.smsSummaryU" %>
                                ...
                                <div class="row">
                                    <%--<div class="col-md-1">
                                     ...
                                     <div class="col-md-2" style="display:none;">
                                        <asp:TextBox ID="txtProfile" runat="server" class="form-control" placeholder="User ID" autocomplete="off"></asp:TextBox>
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-4">
                                        <asp:LinkButton runat="server" ID="lnkCampRep"  class="btn btn-mini" PostBackUrl="~/campReportU.aspx">
                                                    Campaign Report <i class="fas fa-forward" aria-hidden="true"></i>
                                        </asp:LinkButton>
                                    </div>
