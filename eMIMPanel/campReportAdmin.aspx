<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="campReportAdmin.aspx.cs" Inherits="eMIMPanel.campReportAdmin" %>
                        ...
                        <div>
                            <div class="right-view">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3">
                                        <%--<asp:TextBox ID="txtFrm" runat="server" onchange="javascript:text_changed_from();" TextMode="Date" class="form-control" placeholder="From Date" autocomplete="off"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        <%--<asp:TextBox ID="txtTo" runat="server" onchange="javascript:text_changed_to();" TextMode="Date" class="form-control mt-3 my-lg-0" placeholder="To Date" autocomplete="off"></asp:TextBox>
