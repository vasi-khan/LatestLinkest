...
namespace eMIMPanel
{
    public partial class sms_reports_usr_new : System.Web.UI.Page
    {
        string d1 = "";
        string d2 = "";
        string s1 = "";
        ...
        public void GetData()
        {
            ...
            DataTable dt = ob.GetSMSReport_user_new3(s1, s2, usertype, user, ddlCamp.SelectedValue, txtMobileNo.Text.Trim(), TempIdAndName);
        ...
        protected void btnXL_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = ob.GetSMSReportDetail_user_new2(userid.Value, fileid.Value, lblsender.Text, s1, s2, reqsrc,txtMobileNo.Text.Trim());
