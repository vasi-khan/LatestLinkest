<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SubLocationMaster.aspx.cs" Inherits="eMIMPanel.SubLocationMaster" %>
            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb" class="my-3">
                    <ol class="breadcrumb breadcrumb-info">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sub Location Master</li>
                    </ol>
                </nav>
                                ...
                                <asp:Panel ID="pnlMain" runat="server">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <asp:TextBox ID="txtSubLocCode" runat="server" CssClass="form-control" onkeypress="return /^[a-zA-Z0-9-_\s]{0,20}$/.test(this.value+event.key);" MaxLength="20"></asp:TextBox>
                                        </div>
                                        <div class="col-md-3">
                                            <label>Sub Location Name</label>
                                            <asp:TextBox ID="txtSubLocName" runat="server" CssClass="form-control" onkeypress="return /^[a-zA-Z0-9-_.\s]{0,100}$/.test(this.value+event.key);" MaxLength="100"></asp:TextBox>
                                        </div>
                            ...
                            <div class="mt-5 px-4" runat="server" id="divgrdtran">
                                <asp:GridView ID="grd" border="0" runat="server" CellPadding="10" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Group Location Name" HeaderStyle-Width="25%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCategoryName" runat="server" Text='<%#Eval("CategoryName")%>' Width="100%"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Location" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLocationName" runat="server" Text='<%#Eval("LocationName")%>' Width="100%"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Sub Location Code" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblsubLocationID" runat="server" Text='<%#Eval("SubLocationID")%>' Width="100%"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Sub Location Name" HeaderStyle-Width="25%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:HiddenField Value='<%#Eval("SubLocationID") %>' ID="HD_SubLocationID" runat="server" />
