...
namespace eMIMPanel
{
    public partial class send_sms_u1 : System.Web.UI.Page
    {
        string tempVar = "{#var#}";
        string _user = "";
        string paisa = "";
        ...
        public bool MsgSend(string sch)
        {
            ...
            if (sch != "")
            {
                if (Convert.ToString(Session["XLUPLOADED"]) == "Y")
                {
                    ...
                    // ob.Schedule_SMS_BULK(UserID, txtMsg.Text, ddlSender.Text, sch, shortURLId, shortURL, ws, rate, ddlSMSType.SelectedValue, filenm, filenmext, dtSMPPAC, "", ucs2, mobList, "", templID, country_code);
                }
                else
                {
                    ...
                    else
                    {
                        foreach (var m in mobList)
                        {
                            ...
                            if (chk == 0)
                            {
                                ...
                                //  ob.Schedule_SMS(UserID, m, msg, ddlSender.Text, sch, shortURLId, shortURL, ws, mseg, rate, ddlSMSType.SelectedValue, dtSMPPAC, ucs2, templID, country_code);
                                //if (ddlSMSType.SelectedValue == "2")
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        foreach (var m in mobList)
                        {
                            ...
                            if (chk == 0)
                            {
                                ob.SendURL_SMS(UserID, m, msg.Trim(), ddlSender.Text, dtSMPPAC, ucs2, bulk, rate, noofsms, templID, country_code, ddlSMSType.SelectedValue, fileId);
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('SMS Sent Successfully');window.location ='send-sms_u1.aspx';", true);
            }
            return true;
        }
        ...
        {
            Response.Redirect("send-sms_u1.aspx");
        }
        ...
        protected void btnScheduleSMS_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (res == true)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('SMS Scheduled Successfully');window.location ='send-sms_u1.aspx';", true);
