<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="send-sms-u-B4SendDemo.aspx.cs" Inherits="eMIMPanel.send_sms_u_B4SendDemo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline pl-2">
                                        <asp:RadioButton class="mr-2" ID="rdbImport" runat="server" GroupName="mobile" AutoPostBack="true" OnCheckedChanged="rdbUpload_CheckedChanged" />
                                        <label><asp:LinkButton ID="lnkbtnimport" runat="server" Enabled="false" Text="Import From Group" OnClick="lnkbtnimport_Click">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="d-flex flex-md-row flex-wrap justify-content-between">
                                        ...
                                        <p class="my-2">
                                            <span class="font-weight-bold small">Exclude Number Count:</span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <asp:LinkButton ID="LinkButton1" Visible="false" runat="server" class="btn btn-primary text-secondary small btn-block my-3 my-lg-0" OnClick="btnInsURL_Click">
                            ...
                            <div class="form-group row" id="divSmsPreview" runat="server" visible="false">
                                <label for="exampleFormControlTextarea2" class="col-sm-2 col-form-label font-weight-bold">SMS Preview: </label>
                                <div class="col-sm-10">
                                    <div id="div12" runat="server">
                                        <asp:TextBox ID="txtsmspreview" runat="server" TextMode="MultiLine" class="form-control" Rows="3" disabled="disabled"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" id="divscratchcard" runat="server" visible="false">
                                <%--<label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label font-weight-bold">Send Scratch Card</label>--%>
    ...
    <asp:Panel ID="pnlPopUp_GROUP" runat="server" CssClass="modalPopup" Style="display: none;">
        <div style="overflow-y: auto; overflow-x: hidden; max-height: 450px;">
            <div class="modal-header">
                ...
                <div>
                Total Groups : <asp:Label ID="lbltotgroups" runat="server" CssClass="modal-title"></asp:Label>&nbsp;
                Selected Groups : <asp:Label ID="lblselectedgrp" runat="server" CssClass="modal-title"></asp:Label>&nbsp;&nbsp;
                    </div>
            ...
            <div class="modal-body">
              ...
              <%--<asp:ListBox ID="ddlGrp1" runat="server" SelectionMode="Multiple" Height="150px" Width="200px"></asp:ListBox>--%>
            ...
            <%--</ContentTemplate>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnCleargroup" />
        </Triggers>
    </asp:UpdatePanel>--%>
    ...
    <script type="text/javascript">
        ...
        function showLoading() {
            ...
            //document.getElementById('<%= lblUploading.ClientID %>').innerText = "Uploading. Please Wait ... ";
